...
def get_args():
    ...
    optional.add_argument('--n_steps', type=int, default=2000, help='Number of training steps (default is 2000)')
    ...
    optional.add_argument('--er', type=bool, help='Experience replay or not, default False',default=True)
    optional.add_argument('--mpo', type=bool, help='Multiple properties or not, default False',default=True)
