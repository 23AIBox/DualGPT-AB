...
class AASeqDictionary_con_2(object):
    """
    ...
    def __init__(self):
        self.char_idx = {self.PAD: 0, self.BEGIN: 1, self.END: 2, 'A': 3, 'R': 4, 'N': 5, 'D': 6, 'C': 7, 'E': 8,
                         ...
                         'good_HISum':28, 'bad_HISum':29,'good_MHC2':30,'bad_MHC2':31,'good_HER2':32,'bad_HER2':33
                         }  # X for unknown AA
...
def condition_convert(con_df):
    con_df = con_df.copy()  # 创建DataFrame的副本
    ...
    con_df.loc[con_df['raw_MHC2'] <= 2.51 , 'raw_MHC2'] = 0
    con_df.loc[con_df['raw_MHC2'] > 2.51 , 'raw_MHC2'] = 1
    con_df.loc[con_df['raw_HER2'] > 0.7 , 'raw_HER2'] = 1
    con_df.loc[con_df['raw_HER2'] <= 0.7 , 'raw_HER2'] = 0
    ...
    con_df.loc[con_df['raw_MHC2'] == 1, 'raw_MHC2'] = 'good_MHC2'
    con_df.loc[con_df['raw_MHC2'] == 0, 'raw_MHC2'] = 'bad_MHC2'
    con_df.loc[con_df['raw_HER2'] == 1, 'raw_HER2'] = 'good_HER2'
    con_df.loc[con_df['raw_HER2'] == 0, 'raw_HER2'] = 'bad_HER2'
...
class Experience(object):
    ...
    def __init__(self, max_size=100):
        ...
        self.sd = AASeqDictionary_con_2()  # using to replace voc
